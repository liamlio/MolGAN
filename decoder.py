...
from jicml18_jtnn.jtnn.jtnn_vae import JTNNVAE
from jicml18_jtnn.jtnn.mol_tree import Vocab

class Options:
    def __init__(self,
                 jtvae_path="./jicml18_jtnn/",
                 hidden_size=450,
                 latent_size=56,
                 depth=3,
...
def main():
    ...
    parser.add_argument("--jtvae_path", default="./jicml18_jtnn/")
    ...
    parser.add_argument("--data_path", default="./results")
    parser.add_argument("--file_to_encode", default="200_epoch_GAN_encoded_")
